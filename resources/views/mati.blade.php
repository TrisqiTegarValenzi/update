...
<head>
  ...
  <nav class="navbar navbar-dark bg-dark fixed-top">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">Data Hewan Mati</a>
...
<body d="bg-edit" style="
  ...
  <div class="container py-5" style="margin-top: 50px;">
    <h1 class="text-center">Data Hewan Mati</h1>
    <div class="container py-1 " style="margin-top:20px ;">
      <div class="col-sm-12 pull-right">
        <div class="pull-right">
          <a href="/tambahmati" type="button" class="btn btn-dark">Tambah Data</a>
          <div class="container py-1 " style="margin-top:20px ;">
      ...
      <table class="table table-striped table-hover">
        <thead class="table-dark">
          <tr>
            ...
            <th scope="col">Kasus Kematian</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{ $row->kasus }}</td>
            <td>
            -- <a href="/tampilmati/{{ $row->id }}" class="btn btn-secondary">Edit</a> 
              |
              <a href="/deletemati/{{ $row->id }}" type="button" class="btn btn-dark">Delete</a> --
            </td>
          </tr>
          @endforeach
        </tbody>
