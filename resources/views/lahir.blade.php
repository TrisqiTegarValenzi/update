...
<head>
  ...
  <title>Data Hewan Melahirkan</title>
  ...
  <nav class="navbar navbar-dark bg-dark fixed-top">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">Data Hewan Melahirkan</a>
...
<body d="bg-edit" style="
  ...
  <div class="container py-5" style="margin-top: 50px;">
    <h1 class="text-center">Data Hewan Melahirkan</h1>
    <div class="container py-1 " style="margin-top:20px ;">
      <div class="col-sm-12 pull-right">
        <div class="pull-right">
          <a href="/tambahlahir" type="button" class="btn btn-dark">Tambah Data</a>
          <div class="container py-1 " style="margin-top:20px ;">
      ...
      <table class="table table-striped table-hover">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{ $row->anak }}</td>
            <td>
            -- <a href="/tampillahir/{{ $row->id }}" class="btn btn-secondary">Edit</a> 
              |
              <a href="/deletelahir/{{ $row->id }}" type="button" class="btn btn-dark">Delete</a> --
            </td>
          </tr>
          @endforeach
        </tbody>
