    ...
    <div class="container py-1 " style="margin-top:20px ;">
      <div class="col-sm-12 pull-right">
        <div class="pull-right">
          <a href="/tambahpegawai" type="button" class="btn btn-dark">Tambah Data</a>
          <div class="container py-1 " style="margin-top:20px ;">
      ...
      <table class="table table-striped table-hover">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{ $row->notelp }}</td>
            <td>{{ $row->jenis }}</td>
            <td>{{ $row->pekerjaan->kerja }}</td>
            <td>
              -- <a href="/tampilpegawai/{{ $row->id }}" class="btn btn-secondary">Edit</a>
              |
              <a href="/deletepegawai/{{ $row->id }}" type="button" class="btn btn-dark">Delete</a> --
            </td>
          </tr>
          @endforeach
        </tbody>
